const metadata = {
    cli: 'npx velour-ui add interactive-3d-particles',
...
import { ClassNameValue } from "tailwind-merge";
    `,
    demo: `<Interactive3DParticles title='VELOUR UI' />`,
    hasVariants: false,
    variants: [{
    ...
    hasLiveDemo: true,
    code: `
     import Interactive3DParticles from "@/components/ui/Interactive3DParticles";
    
    <Interactive3DParticles title='VELOUR UI' />
        `,
    manualSteps: [
        {
            title: "Install the following dependencies:",
            code: "npm install tailwind-merge rapier three"
        },
        {
